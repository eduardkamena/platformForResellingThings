...
public class CommentsController {
    ...
    public ResponseEntity<Comment> addComment(@PathVariable int id,
        ...
        return ResponseEntity.ok(adsService.addComment(id, createOrUpdateComment, authentication.getName()));
    }
    ...
    public ResponseEntity<Comment> updateComment(@PathVariable int adId,
                                                 ...
                                                 @RequestBody CreateOrUpdateComment createOrUpdateComment) {
        return ResponseEntity.ok(adsService.updateComment(adId, commentId, createOrUpdateComment));
    }
